...
bool sim_interfaces__msg__waypoint_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_interfaces.msg._waypoint_list.WaypointList", full_classname_dest, 46) == 0);
  }
  sim_interfaces__msg__WaypointList * ros_message = _ros_message;
  {  // header
...
PyObject * sim_interfaces__msg__waypoint_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_interfaces.msg._waypoint_list");
