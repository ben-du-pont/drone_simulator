...
#include "sim_interfaces/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_c.h"
...
using _WaypointList__ros_msg_type = sim_interfaces__msg__WaypointList;
...
static uint32_t _WaypointList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sim_interfaces__msg__WaypointList(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sim_interfaces__msg__WaypointList;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _WaypointList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sim_interfaces__msg__WaypointList(
