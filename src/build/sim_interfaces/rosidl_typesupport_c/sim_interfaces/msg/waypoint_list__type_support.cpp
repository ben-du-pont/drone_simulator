...
static const _WaypointList_type_support_symbol_names_t _WaypointList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_interfaces, msg, WaypointList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_interfaces, msg, WaypointList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_interfaces, msg, WaypointList)() {
  return &::sim_interfaces::msg::rosidl_typesupport_c::WaypointList_message_type_support_handle;
}
