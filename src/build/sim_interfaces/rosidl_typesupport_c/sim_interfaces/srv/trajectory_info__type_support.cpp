...
static const _TrajectoryInfo_Request_type_support_symbol_names_t _TrajectoryInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_interfaces, srv, TrajectoryInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_interfaces, srv, TrajectoryInfo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_interfaces, srv, TrajectoryInfo_Request)() {
  return &::sim_interfaces::srv::rosidl_typesupport_c::TrajectoryInfo_Request_message_type_support_handle;
}
...
static const _TrajectoryInfo_Response_type_support_symbol_names_t _TrajectoryInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_interfaces, srv, TrajectoryInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_interfaces, srv, TrajectoryInfo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_interfaces, srv, TrajectoryInfo_Response)() {
  return &::sim_interfaces::srv::rosidl_typesupport_c::TrajectoryInfo_Response_message_type_support_handle;
}
...
static const _TrajectoryInfo_type_support_symbol_names_t _TrajectoryInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_interfaces, srv, TrajectoryInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_interfaces, srv, TrajectoryInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, sim_interfaces, srv, TrajectoryInfo)() {
  return &::sim_interfaces::srv::rosidl_typesupport_c::TrajectoryInfo_service_type_support_handle;
}
