...
class Metaclass_DronePosition(type):
    """Metaclass of message 'DronePosition'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sim_interfaces.msg.DronePosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__drone_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__drone_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__drone_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__drone_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__drone_position
...
class DronePosition(metaclass=Metaclass_DronePosition):
    """Message class 'DronePosition'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.waypoints_achieved = kwargs.get('waypoints_achieved', int())
    ...
    def __eq__(self, other):
        ...
        if self.position_z != other.position_z:
            return False
        if self.waypoints_achieved != other.waypoints_achieved:
            return False
    ...
    @builtins.property
    def waypoints_achieved(self):
        """Message field 'waypoints_achieved'."""
        return self._waypoints_achieved

    @waypoints_achieved.setter
    def waypoints_achieved(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'waypoints_achieved' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'waypoints_achieved' field must be an integer in [-2147483648, 2147483647]"
        self._waypoints_achieved = value
