...
bool sim_interfaces__msg__anchor_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_interfaces.msg._anchor_info.AnchorInfo", full_classname_dest, 42) == 0);
  }
  sim_interfaces__msg__AnchorInfo * ros_message = _ros_message;
  {  // header
  ...
  {  // ids
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->ids.data;
  ...
  {  // constant_bias
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->constant_bias.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'constant_bias'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // linear_bias
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->linear_bias.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'linear_bias'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // types
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->types.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of AnchorInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_interfaces.msg._anchor_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnchorInfo");
  ...
  {  // ids
    ...
    rosidl_runtime_c__String * src = ros_message->ids.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "ids", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // constant_bias
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "constant_bias");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->constant_bias.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->constant_bias.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->constant_bias.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // linear_bias
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "linear_bias");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->linear_bias.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->linear_bias.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->linear_bias.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // types
    ...
    if (ros_message->types.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->types.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->types.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
