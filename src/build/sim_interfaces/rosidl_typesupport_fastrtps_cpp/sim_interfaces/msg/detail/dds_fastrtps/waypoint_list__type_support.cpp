...
#include "sim_interfaces/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sim_interfaces::msg::WaypointList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sim_interfaces::msg::WaypointList & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sim_interfaces::msg::WaypointList;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const sim_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sim_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  return &sim_interfaces::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sim_interfaces, msg, WaypointList)() {
  return &sim_interfaces::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
